# Testing Team Guide — All Uses Coverage (coverage.py + beniget)
...
Cloned from [testable-whitebox-python](https://github.com/bipinvk47/testable-whitebox-python):
...
GitHub Actions runs `pytest` and `all_uses_coverage_trigger.py` on every push.
